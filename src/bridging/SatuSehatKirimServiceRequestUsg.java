 ...
 * @author dosen
 */
public final class SatuSehatKirimServiceRequestUsg extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SatuSehatKirimServiceRequestUsg(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengiriman Data Service Request USG Satu Sehat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
                        ...
                        "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                            "<tr class='isi2'>"+
                                "<td valign='top' align='center'>"+
                                    ...
                                    "<font size='2' face='Tahoma'>DATA PENGIRIMAN SATU SEHAT SERVICE REQUEST USG<br><br></font>"+        
                                "</td>"+
                           "</tr>"+
                        "</table>")
            );
                ...
                try {
                    ...
                    try{
                        ...
                        json = "{" +
                                    ...
                                    "\"identifier\": [" +
                                        "{" +
                                            ...
                                            "\"value\": \""+tbObat.getValueAt(i,1).toString().replaceAll("/","")+"\"" +
                                        "}" +
                                    "]," +
                                    "\"status\": \"active\"," +
                                    "\"intent\": \"order\"," +
                        ...
                        if(!response.asText().equals("")){
                            if(Sequel.menyimpantf2("satu_sehat_servicerequest_usg","?,?","No.Rawat",2,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatKirimServiceRequestUsg dialog = new SatuSehatKirimServiceRequestUsg(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            // Create Table if Is Not Exists (Lazy init)
            try {
                 ps = koneksi.prepareStatement("CREATE TABLE IF NOT EXISTS satu_sehat_servicerequest_usg (no_rawat varchar(17) NOT NULL, id_servicerequest varchar(50) DEFAULT NULL, PRIMARY KEY (no_rawat)) ENGINE=InnoDB DEFAULT CHARSET=latin1");
                 ps.execute();
                 ps.close();
            } catch (Exception e) {}
            ...
            ps=koneksi.prepareStatement(
                   ...
                   "satu_sehat_encounter.id_encounter,hasil_pemeriksaan_usg.no_rawat as no_permintaan,date(hasil_pemeriksaan_usg.tanggal) as tgl_permintaan,time(hasil_pemeriksaan_usg.tanggal) as jam_permintaan,"+
                   "hasil_pemeriksaan_usg.diagnosa_klinis,"+
                   "'USG' as nm_perawatan,'268445003' as code,'http://snomed.info/sct' as system,'Obstetric ultrasound scan' as display,"+
                   "ifnull(satu_sehat_servicerequest_usg.id_servicerequest,'') as id_servicerequest,'' as kd_jenis_prw "+
                   ...
                   "inner join hasil_pemeriksaan_usg on hasil_pemeriksaan_usg.no_rawat=reg_periksa.no_rawat "+
                   "left join satu_sehat_servicerequest_usg on satu_sehat_servicerequest_usg.no_rawat=hasil_pemeriksaan_usg.no_rawat "+
                   "where date(hasil_pemeriksaan_usg.tanggal) between ? and ? "+
                   (TCari.getText().equals("")?"":"and (reg_periksa.no_rawat like ? or reg_periksa.no_rkm_medis like ? or "+
                   "pasien.nm_pasien like ? or pasien.no_ktp like ? or pegawai.nama like ? or hasil_pemeriksaan_usg.diagnosa_klinis like ?)"));
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("nama"),rs.getString("ktpdokter"),rs.getString("id_encounter"),rs.getString("no_permintaan"),rs.getString("tgl_permintaan")+" "+rs.getString("jam_permintaan"),
