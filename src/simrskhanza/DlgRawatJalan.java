...
import surat.SuratPernyataanKronologis;
...
import rekammedis.RMPermintaanTerapi;
...
import rekammedis.RMOperasiMata;
...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnTarikDataAsesmen = new widget.Button();
        BtnRiwayatICare = new widget.Button();
        BtnRencanaKontrolBPJS = new widget.Button();
        ...
        panelDiagnosa1 = new laporan.PanelDiagnosaIDRG();
       // panelDiagnosa1 = new laporan.PanelDiagnosa();//
        ...
        //ipinoperasimata//
        BtnCatatanOperasiMata = new widget.Button();
        //ipinoperasimata//
        BtnSuratPernyataanKronologis = new widget.Button();
        BtnDataAlergiPasien = new widget.Button();
        ...
        BtnTarikDataAsesmen.setIcon(
            new javax.swing.ImageIcon(
                getClass().getResource("/picture/medical-folder_4006285.png")
            )
        );
        BtnTarikDataAsesmen.setMnemonic('S');
        BtnTarikDataAsesmen.setText("Tarik Data Asesmen");
        BtnTarikDataAsesmen.setToolTipText("Alt+T");
        BtnTarikDataAsesmen.setName("BtnTarikDataAsesmen");
        BtnTarikDataAsesmen.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnTarikDataAsesmen.addActionListener(
            new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    BtnTarikDataAsesmenActionPerformed(evt);
                }
            }
        );
        panelGlass12.add(BtnTarikDataAsesmen);
        BtnTarikDataAsesmen.setBounds(920, 85, 170, 23);

        //Button Icare//
        BtnRiwayatICare.setIcon(
            new javax.swing.ImageIcon(
                getClass().getResource("/picture/medical-folder_4006285.png")
            )
        );
        BtnRiwayatICare.setMnemonic('I');
        BtnRiwayatICare.setText("Riwayat iCare");
        BtnRiwayatICare.setToolTipText("Alt+I");
        BtnRiwayatICare.setName("BtnRiwayatICare");
        BtnRiwayatICare.setPreferredSize(new java.awt.Dimension(100, 30));
        BtnRiwayatICare.addActionListener(
            new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    BtnRiwayatICareActionPerformed(evt);
                }
            }
        );
        panelGlass12.add(BtnRiwayatICare);
        BtnRiwayatICare.setBounds(920, 110, 170, 23);

//Button Icare//
//Button SKDP//
BtnRencanaKontrolBPJS.setIcon(
    new javax.swing.ImageIcon(
        getClass().getResource("/picture/medical-folder_4006285.png")
    )
);

BtnRencanaKontrolBPJS.setMnemonic('K');
BtnRencanaKontrolBPJS.setText("Rencana Kontrol BPJS");
BtnRencanaKontrolBPJS.setToolTipText("Alt+K");
BtnRencanaKontrolBPJS.setName("BtnRencanaKontrolBPJS");
BtnRencanaKontrolBPJS.addActionListener(new java.awt.event.ActionListener() {
    public void actionPerformed(java.awt.event.ActionEvent evt) {
        tampilkanRencanaKontrolBPJS();
    }
});
panelGlass12.add(BtnRencanaKontrolBPJS);
BtnRencanaKontrolBPJS.setBounds(920, 135, 170, 23);
//Button SKDP//
        ...
        cmbKesadaran.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Compos Mentis", "Somnolence", "Sopor", "Coma","Apatis","Delirium","Asistol","Alert","Confusion","Voice","Pain","Unresponsive"}));
        ...
        FormMenu.setPreferredSize(new java.awt.Dimension(135, 483));
        FormMenu.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 1, 1));

        // Pencarian FormMenu
        jLabel91.setName("jLabel91");
        jLabel91.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/search_14034536.png")));

        tfCariMenu = new JTextField();
        tfCariMenu.setPreferredSize(new Dimension(145, 22));
        tfCariMenu.getDocument().addDocumentListener(new DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                if(tfCariMenu.getText().isEmpty()) {
                    resetMenuVisibility();
                } else {
                    searchMenu();
                }
        ...
        // Set posisi icon jLabel91 agar disamping kiri tfCariMenu dan selevel
        JPanel searchPanel = new JPanel();
        searchPanel.setBackground(new java.awt.Color(240, 240, 240));
        searchPanel.setLayout(new FlowLayout(FlowLayout.LEFT, 5, 10));
        searchPanel.add(jLabel91);
        searchPanel.add(tfCariMenu);
        FormMenu.add(searchPanel);
        ...
        BtnPermintaanTerapi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png")));
        BtnPermintaanTerapi.setText("Permintaan Terapi");
        BtnPermintaanTerapi.setFocusPainted(false);
        BtnPermintaanTerapi.setFont(new java.awt.Font("Tahoma", 0, 11));
        ...
        BtnPermintaanTerapi.setName("BtnPermintaanTerapi");
...
//ipinoperasimata//
        BtnCatatanOperasiMata = new widget.Button();
        BtnCatatanOperasiMata.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png")));
        BtnCatatanOperasiMata.setText("Encoder To Jpg");
        BtnCatatanOperasiMata.setFocusPainted(false);
        BtnCatatanOperasiMata.setFont(new java.awt.Font("Tahoma", 0, 11));
        BtnCatatanOperasiMata.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnCatatanOperasiMata.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnCatatanOperasiMata.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnCatatanOperasiMata.setName("BtnCatatanOperasiMata");
        BtnCatatanOperasiMata.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnCatatanOperasiMata.setRoundRect(false);
        BtnCatatanOperasiMata.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCatatanOperasiMataActionPerformed(evt);
            }
        });
        //ipinoperasimata//

        BtnSuratPernyataanKronologis = new widget.Button();
        BtnSuratPernyataanKronologis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png")));
        BtnSuratPernyataanKronologis.setText("Surat Pernyataan Kronologis");
        BtnSuratPernyataanKronologis.setFocusPainted(false);
        BtnSuratPernyataanKronologis.setFont(new java.awt.Font("Tahoma", 0, 11));
        BtnSuratPernyataanKronologis.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnSuratPernyataanKronologis.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnSuratPernyataanKronologis.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnSuratPernyataanKronologis.setName("BtnSuratPernyataanKronologis");
        BtnSuratPernyataanKronologis.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnSuratPernyataanKronologis.setRoundRect(false);
        BtnSuratPernyataanKronologis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSuratPernyataanKronologisActionPerformed(evt);
            }
        });

        //---- tambahan baru 2026-19-01 ----//
        BtnDataAlergiPasien = new widget.Button();
        BtnDataAlergiPasien.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png")));
        BtnDataAlergiPasien.setText("Data Alergi Pasien");
        BtnDataAlergiPasien.setFocusPainted(false);
        BtnDataAlergiPasien.setFont(new java.awt.Font("Tahoma", 0, 11));
        BtnDataAlergiPasien.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnDataAlergiPasien.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnDataAlergiPasien.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnDataAlergiPasien.setName("BtnDataAlergiPasien");
        BtnDataAlergiPasien.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnDataAlergiPasien.setRoundRect(false);
        BtnDataAlergiPasien.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnDataAlergiPasienActionPerformed(evt);
            }
        });
        //---- tambahan baru 2026-19-01 ----//
...
//Riwayat iCare//
private void BtnRiwayatICareActionPerformed(java.awt.event.ActionEvent evt) {
    tampilkanRiwayatICare();
}

private void tampilkanRiwayatICare() {
    ...
    try {
        ...
        /* ===============================
           1. Ambil No Kartu / NIK Pasien
           =============================== */
        PreparedStatement ps = koneksi.prepareStatement(
            "select pasien.no_peserta, pasien.no_ktp " +
        ...
        if (rs.next()) {
            identitas = rs.getString("no_peserta");
            if (identitas == null || identitas.equals("")) {
                identitas = rs.getString("no_ktp");
            }
        }
        rs.close();
        ps.close();
        ...
        if (identitas.equals("")) {
            JOptionPane.showMessageDialog(null,
                "Pasien bukan peserta BPJS / Identitas tidak ditemukan");
            return;
        }

        /* ===============================
           2. Ambil Dokter (SAMA PERSIS KASIR)
           =============================== */
        ...
        kdDokterBPJS = Sequel.cariIsi(
            "select kd_dokter_bpjs from maping_dokter_dpjpvclaim where kd_dokter=?",
            kdDokter
        );

        if (kdDokterBPJS.equals("")) {
            JOptionPane.showMessageDialog(null,
                "Dokter belum dimapping ke BPJS");
            return;
        }
        ...
        /* ===============================
           3. Tampilkan iCare
           =============================== */
        ICareRiwayatPerawatan dlg =
            new ICareRiwayatPerawatan(null, false);
        dlg.setSize(this.getWidth() - 20, this.getHeight() - 20);
        dlg.setLocationRelativeTo(this);
        dlg.setPasien(identitas, kdDokterBPJS);
        dlg.setVisible(true);
...
//SKDP
/* 
    private void BtnRencanaKontrolBPJSActionPerformed(java.awt.event.ActionEvent evt) {
    if (TNoRw.getText().trim().equals("")) {
        JOptionPane.showMessageDialog(null, "No.Rawat belum dipilih");
        return;
    }
    ...
    JOptionPane.showMessageDialog(null,
        "Rencana Kontrol BPJS dibuka melalui:\n" +
        "Kasir Rawat Jalan → Bridging → Surat Kontrol");
} 
        */
       /* 
    private void tampilkanRencanaKontrolBPJS() {
    if (TNoRw.getText().trim().equals("")) {
        JOptionPane.showMessageDialog(null, "No.Rawat belum dipilih");
        return;
    }
    ...
    try {
        ...
        // opsional: kirim no_rawat supaya langsung terisi
...
private void tampilkanRencanaKontrolBPJS() {
    ...
    try {
        ps = koneksi.prepareStatement(
            "select no_sep,no_kartu,tanggal_lahir,jkel,nmdiagnosaawal " +
        ...
        if (!rs.next()) {
            JOptionPane.showMessageDialog(null,
                "Pasien tersebut belum memiliki SEP BPJS");
            return;
        }
        ...
        // 🔥 INI KUNCINYA (sama persis dengan Kasir)
        form.setNoRm(
            TNoRw.getText(),              // no_rawat
            rs.getString("no_sep"),       // no SEP
            rs.getString("no_kartu"),     // no kartu
            TNoRM.getText(),              // no RM
...
//SKDP
    ...
    private void BtnTarikDataAsesmenActionPerformed(
        java.awt.event.ActionEvent evt
    ) {
        try {
            String sql =
                "SELECT keluhan_utama, rpd, rps, ket_fisik, tata, suhu, rr, tb, bb, gcs, nadi, td, spo " +
                "FROM penilaian_medis_igd WHERE no_rawat=?";
            try (PreparedStatement ps = koneksi.prepareStatement(sql)) {
                ps.setString(1, TNoRw.getText());
                try (ResultSet rs = ps.executeQuery()) {
                    if (rs.next()) {
                        TKeluhan.setText("Keluhan Utama : " + rs.getString("keluhan_utama") + "\n" +
                                         "Riwayat Penyakit Dulu : " + rs.getString("rpd") + "\n" +
                                         "Riwayat Penyakit Sekarang : " + rs.getString("rps"));
                        TPemeriksaan.setText(rs.getString("ket_fisik"));
                        ...
                        SpO2.setText(rs.getString("spo"));
                        TindakLanjut.setText(rs.getString("tata"));
                    }
                }
            }
        } catch (Exception e) {
    ...
    private void BtnPermintaanTerapiActionPerformed(java.awt.event.ActionEvent evt) {
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            ...
            if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                ...
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMPermintaanTerapi dlgro=new RMPermintaanTerapi(null,false);
                dlgro.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
                dlgro.setLocationRelativeTo(internalFrame1);
                dlgro.emptTeks();
                dlgro.isCek();
                dlgro.setNoRm(TNoRw.getText(),DTPCari2.getDate());
                dlgro.tampil();
                dlgro.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
            }
...
//ipinoperasimata//
            private void BtnCatatanOperasiMataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCatatanOperasiMataActionPerformed
                if(TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")){
                    JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan mengklik data pada tabel...!!!");
                    TCari.requestFocus();
                } else {
                    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                    RMDataCatatanOperasiMata form = new RMDataCatatanOperasiMata(null, false);
                    form.isCek();
                    form.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
                    form.setLocationRelativeTo(internalFrame1);
                    form.setVisible(true);
            ...
            }//GEN-LAST:event_BtnCatatanOperasiMataActionPerformed
        //ipinoperasimata//
        // custom04092025
    private void BtnSuratPernyataanKronologisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSuratPernyataanKronologisActionPerformed
        if(TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan mengklik data pada tabel...!!!");
            TCari.requestFocus();
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            SuratPernyataanKronologis form = new SuratPernyataanKronologis(null, false);
            form.isCek();
            form.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    }//GEN-LAST:event_BtnSuratPernyataanKronologisActionPerformed

private void BtnDataAlergiPasienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDataAlergiPasienActionPerformed
    if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
        JOptionPane.showMessageDialog(
            null,
            "Maaf, Silahkan anda pilih dulu dengan mengklik data pada tabel...!!!"
        );
        TCari.requestFocus();
    } else {
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
...
}//GEN-LAST:event_BtnDataAlergiPasienActionPerformed
    ...
    //EEG//
    private void BtnPemeriksaanEEGActionPerformed(java.awt.event.ActionEvent evt) {
        if(TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan mengklik data pada tabel...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPemeriksaanEEG form = new RMPemeriksaanEEG(null, false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20, internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    private void BtnHasilPemeriksaanSpirometriActionPerformed(java.awt.event.ActionEvent evt) {                                                            
        if(TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMHasilPemeriksaanSpirometri form = new RMHasilPemeriksaanSpirometri(null, false);
            form.isCek();
            form.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
...
// penilaianDehidrasi2tambahancustom 04032026
    ...
    private void BtnOperasiMataActionPerformed(java.awt.event.ActionEvent evt) {
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMOperasiMata form=new RMOperasiMata(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    */
    ...
    //ipinoperasimata//
    private widget.Button BtnCatatanOperasiMata;
    //ipinoperasimata//
    ...
    private widget.Button BtnSuratPernyataanKronologis;
    private widget.Button BtnDataAlergiPasien;
    ...
    private widget.Button BtnTarikDataAsesmen;
    private widget.Button BtnRiwayatICare;
    private widget.Button BtnRencanaKontrolBPJS;
    private bridging.ICareRiwayatPerawatan iCare;
    ...
    private laporan.PanelDiagnosaIDRG panelDiagnosa1;
   //private laporan.PanelDiagnosa panelDiagnosa1;//
    ...
    public void isCek(){
        tinggi=0;
        BtnSimpan.setEnabled(akses.gettindakan_ralan());
        BtnTarikDataAsesmen.setEnabled(akses.gettindakan_ralan());
        BtnRiwayatICare.setEnabled(akses.gettindakan_ralan());
        BtnRencanaKontrolBPJS.setEnabled(akses.getskdp_bpjs());
        BtnHapus.setEnabled(akses.gettindakan_ralan());
        BtnEdit.setEnabled(akses.gettindakan_ralan());
        BtnPrint.setEnabled(akses.gettindakan_ralan());
        ...
        BtnPermintaanTerapi.setVisible(akses.getpermintaan_radiologi());
        if(akses.getpermintaan_radiologi()==true){
            tinggi=tinggi+24;
        }
        ...
        //ipinoperasimata//
        BtnCatatanOperasiMata.setVisible(akses.getcatatan_operasi_mata());
        if (akses.getcatatan_operasi_mata() == true) {
            tinggi = tinggi + 24;
        }
        //ipinoperasimata//
        BtnSuratPernyataanKronologis.setVisible(akses.getsurat_pernyataan_kronologis());
        if (akses.getsurat_pernyataan_kronologis() == true) {
        tinggi = tinggi + 24;
        }                     

        BtnDataAlergiPasien.setVisible(akses.getdata_alergi_pasien());
        if(akses.getdata_alergi_pasien()==true){
            tinggi=tinggi+24;
        }
        ...
        BtnPemeriksaanEEG.setVisible(akses.gethasil_pemeriksaan_ekg());
        if(akses.gethasil_pemeriksaan_ekg()==true){
            tinggi=tinggi+24;
        }
        ...
        BtnOperasiMata.setVisible(akses.gethasil_pemeriksaan_echo());
        if(akses.gethasil_pemeriksaan_echo()==true){
            tinggi=tinggi+24;
        }
...
//Bukasoap
public void bukaDariBookingOperasi(String norawat) {
    setNoRm(norawat, new Date(), new Date());

    // 🔥 PAKSA lifecycle windowOpened
    this.dispatchEvent(
        new java.awt.event.WindowEvent(
            this, java.awt.event.WindowEvent.WINDOW_OPENED
        )
    );
}
...
//Bukasoap
    ...
    private void initRawatJalan(){
        ...
        BtnPemeriksaanEEG = new widget.Button();
        BtnPemeriksaanEEG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png")));
        BtnPemeriksaanEEG.setText("Pemeriksaan EEG");
        BtnPemeriksaanEEG.setFocusPainted(false);
        BtnPemeriksaanEEG.setFont(new java.awt.Font("Tahoma", 0, 11));
        BtnPemeriksaanEEG.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnPemeriksaanEEG.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPemeriksaanEEG.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnPemeriksaanEEG.setName("BtnPemeriksaanEEG");
        BtnPemeriksaanEEG.setPreferredSize(new java.awt.Dimension(190, 23));
        ...
        BtnHasilPemeriksaanSpirometri.setFocusPainted(false);
        BtnHasilPemeriksaanSpirometri.setFont(new java.awt.Font("Tahoma", 0, 11));
        BtnHasilPemeriksaanSpirometri.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnHasilPemeriksaanSpirometri.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnHasilPemeriksaanSpirometri.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnHasilPemeriksaanSpirometri.setName("BtnHasilPemeriksaanSpirometri");
        BtnHasilPemeriksaanSpirometri.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnHasilPemeriksaanSpirometri.setRoundRect(false);
        BtnHasilPemeriksaanSpirometri.addActionListener(this::BtnHasilPemeriksaanSpirometriActionPerformed);
        ...
        BtnOperasiMata = new widget.Button();
        BtnOperasiMata.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png")));
        BtnOperasiMata.setText("Data Operasi Mata");
        BtnOperasiMata.setFocusPainted(false);
        BtnOperasiMata.setFont(new java.awt.Font("Tahoma", 0, 11));
        BtnOperasiMata.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnOperasiMata.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnOperasiMata.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnOperasiMata.setName("BtnOperasiMata");
        BtnOperasiMata.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnOperasiMata.setRoundRect(false);
        BtnOperasiMata.addActionListener(this::BtnOperasiMataActionPerformed);
        ...
        BtnPermintaanKonsultasiMedik.setText("Konsultasi Internal");
        ...
        //ipinoperasimata//
        FormMenu.add(BtnCatatanOperasiMata);
         //ipinoperasimata//
    ...
    private void searchMenu() {
        String keyword = tfCariMenu.getText().toLowerCase();

        // Dapatkan semua komponen dalam FormMenu
        Component[] components = FormMenu.getComponents();
        ...
        for(Component component : components) {
            if(component instanceof JButton) {
                ...
                // Tampilkan button jika mengandung keyword, sembunyikan jika tidak
