...
import rekammedis.RMLaporanTindakanParu;
...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnHandover.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnHandover.setText("Lembar Handover");
        BtnHandover.setFocusPainted(false);
        BtnHandover.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnHandover.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnHandover.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnHandover.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnHandover.setName("BtnHandover"); // NOI18N
        BtnHandover.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnHandover.setRoundRect(false);
        ...
        BtnKonsultasi = new widget.Button();
        BtnKonsultasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png")));
        BtnKonsultasi.setText("Lembar Konsultasi Spesialis");
        BtnKonsultasi.setFocusPainted(false);
        BtnKonsultasi.setFont(new java.awt.Font("Tahoma", 0, 11));
        BtnKonsultasi.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnKonsultasi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnKonsultasi.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnKonsultasi.setName("BtnAwalKeperawatanNeonatus");
        BtnKonsultasi.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnKonsultasi.setRoundRect(false);
        BtnKonsultasi.addActionListener(this::BtnKonsultasiActionPerformed);
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnKonsultasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSkorStewardPascaAnestesiActionPerformed
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    private void BtnHandoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSkorStewardPascaAnestesiActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMDataHandover form=new RMDataHandover(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
...
// ===== Custom by ChatGPT PenilaianDerajatDehidrasi2 START =====
    ...
    private void BtnLaporanTindakanActionPerformed(java.awt.event.ActionEvent evt) {
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            ...
            // ===== Custom by ChatGPT TindakanParu START =====
        private void BtnLaporanTindakanParuActionPerformed(java.awt.event.ActionEvent evt) { 
            if(TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")){
                JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan mengklik data pada tabel...!!!");
                TCari.requestFocus();
            } else {
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMLaporanTindakanParu form = new RMLaporanTindakanParu(null, false);
                form.isCek();
                form.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
                form.setLocationRelativeTo(internalFrame1);
                form.setVisible(true);
        ...
        // ===== Custom by ChatGPT TindakanParu END =====
     // ===== Custom by ChatGPT Data Alergi Pasien START =====
private void BtnDataAlergiPasienActionPerformed(java.awt.event.ActionEvent evt) { 
    if(TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")){
        JOptionPane.showMessageDialog(null,
...
// ===== Custom by ChatGPT Data Alergi Pasien END =====
// ===== Custom by ChatGPT Surat Pernyataan Kronologis START =====
private void BtnSuratPernyataanKronologisActionPerformed(java.awt.event.ActionEvent evt) { 
    if(TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")){
        JOptionPane.showMessageDialog(null,
            "Maaf, Silahkan anda pilih dulu dengan mengklik data pada tabel...!!!");
        TCari.requestFocus();
...
// ===== Custom by ChatGPT Surat Pernyataan Kronologis END =====
...
//BUKASOAP//
    ...
    public void isCek(){
        ...
        // ===== Custom by ChatGPT TindakanParu START =====
        BtnLaporanTindakanParu.setVisible(akses.getlaporan_tindakan_paru());
        if(akses.getlaporan_tindakan_paru() == true){
        tinggi = tinggi + 24;
        }
        // ===== Custom by ChatGPT TindakanParu END =====
...
*/
        ...
        BtnLaporanTindakan.addActionListener(this::BtnLaporanTindakanActionPerformed);
         ...
         // ===== Custom by ChatGPT TindakanParu START =====
        BtnLaporanTindakanParu = new widget.Button();
        BtnLaporanTindakanParu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png")));
        BtnLaporanTindakanParu.setText("Laporan Tindakan Thoracosintesis");
        BtnLaporanTindakanParu.setFocusPainted(false);
        BtnLaporanTindakanParu.setFont(new java.awt.Font("Tahoma", 0, 11));
        BtnLaporanTindakanParu.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnLaporanTindakanParu.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnLaporanTindakanParu.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnLaporanTindakanParu.setName("BtnLaporanTindakanParu");
        BtnLaporanTindakanParu.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnLaporanTindakanParu.setRoundRect(false);
        BtnLaporanTindakanParu.addActionListener(this::BtnLaporanTindakanParuActionPerformed);
        // ===== Custom by ChatGPT TindakanParu END =====
        ...
        BtnSuratPernyataanKronologis.addActionListener(this::BtnSuratPernyataanKronologisActionPerformed);
        ...
        FormMenu.add(BtnHandover);
        FormMenu.add(BtnKonsultasi);
...
//      FormMenu.add(BtnPermintaanKonsultasiMedik);
        ...
        FormMenu.add(BtnLaporanTindakanParu);
