    ...
    private void cetakPreview() {
        ...
        try {
            ...
            sb.append("<!DOCTYPE html><html lang='id'><head>")
              ...
              .append("<table class='ttd-tbl'><tr>")
              .append("<td style='width:60%'></td>")
              .append("<td>Makassar, ").append(tglRekaman.substring(0, 10)).append("<br/>Yang Memeriksa,<br/><br/><br/><br/>")
              .append("<b>Dr. ").append(nmDokter).append("</b>")
              .append("</td></tr></table>")
              .append("</div>")
